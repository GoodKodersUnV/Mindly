  "use client";import { CircularProgressbarWithChildren } from "react-circular-progressbar";
...
const Page = () => {
    ...
    return (
        <div className="relative flex flex-col py-10 items-center">
            {buttons.map((button, index) => (
                <div key={button.id} className="relative flex flex-col items-center mb-20" style={{ marginLeft: index % 2 === 0 ? "140px" : "-140px" }}>
                    ...
                    >
                        <div className="relative">
                            <div className="h-[102px] w-[102px] relative">
                                ...
                                >
                                    <button className={cn(
                                            "h-[70px] hover:h-[80px] hover:w-[80px] w-[70px] rounded-full flex justify-center items-center border-2 border-gray-300",
                                            button.locked ? "bg-red-500" : "bg-green-500",
                                            "transform hover:-translate-y-1 active:translate-y-0 transition duration-200"
                                        )}
